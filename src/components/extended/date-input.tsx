...
const DateInput: React.FC<DateInputProps> = ({ value, onChange }) => {
  ...
  return (
    <div className="flex border rounded-lg items-center text-sm px-2.5 py-1.5">
      <input
        type="text"
        ref={monthRef}
        max={12}
      ...
      <input
        ...
        className="p-0 outline-none w-8 border-none text-center"
        placeholder="D"
      />
      <span className="opacity-20 mx-0.5">/</span>
      <input
        ...
        className="p-0 outline-none w-14 border-none text-center"
        placeholder="YYYY"
      />
    </div>
  );
